...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 12 12:19:16 2018
...
def dist(p0, p1):
    import math
    return math.sqrt((p0[0] - p1[0])**2 + (p0[1] - p1[1])**2 + (p0[2] - p1[2])**2 + (p0[3] - p1[3])**2)
...
def mymedian(x,y,a):
    ...
    if str(x)==str(y) and str(x)==str(a): #if all three points are the same
        ...
        o = [x[0]+k[0]*t,x[1]+k[1]*t,x[2]+k[2]*t,x[3]+k[3]*t] #finds right point
    return o
    ...
    if all_same(B)==True:
     ...
     #   z=np.median(B,axis=0)
        ...
        for u in range(len(B)):
            s[u] = (B[u][0] / (dist(B[u], (.3,.3,.3,.3))),(B[u][1] / (dist(B[u], (.3,.3,.3,.3)))),(B[u][2] / (dist(B[u], (.3,.3,.3,.3)))),(B[u][3] / (dist(B[u], (.3,.3,.3,.3)))))
            S    = np.sum(s,axis=0)
            t[u] = 1 / dist(B[u],(.3 ,.3,.3,.3))
            T    = sum(t)
        a   =[0]*4
        a[0]= S[0]/T
        a[1]= S[1]/T
        ...
        if tuple(a) in B:
            ...
            t=[0]*len(B)
            for u in range(len(B)):
                s[u] = (B[u][0] / (dist(B[u], a)),(B[u][1] / (dist(B[u], a))),(B[u][2] / (dist(B[u], a))),(B[u][3] / (dist(B[u], a))))
                S    = np.sum(s,axis=0)
                t[u] = 1 / dist(B[u],a)
                T    = sum(t)
            b   =[0]*4
            ...
            if tuple(b) in B:
                ...
                t=[0]*len(B)
                for u in range(len(B)):
                    s[u] = (B[u][0] / (dist(B[u], b)),(B[u][1] / (dist(B[u], b))),(B[u][2] / (dist(B[u], b))),(B[u][3] / (dist(B[u], b))))
                    S    = np.sum(s,axis=0)
                    t[u] = 1 / dist(B[u],b)
                    T    = sum(t)
                c   =[0]*4
                ...
                if tuple(c) in B:
                    ...
                    t=[0]*len(B)
                    for u in range(len(B)):
                        s[u] = (B[u][0] / (dist(B[u], c)),(B[u][1] / (dist(B[u], c))),(B[u][2] / (dist(B[u], c))),(B[u][3] / (dist(B[u], c))))
                        S    = np.sum(s,axis=0)
                        t[u] = 1 / dist(B[u],c)
                        T    = sum(t)
                    d   =[0]*4
                    ...
                    if tuple(d) in B:
                        ...
                        t=[0]*len(B)
                        for u in range(len(B)):
                            s[u] = (B[u][0] / (dist(B[u], d)),(B[u][1] / (dist(B[u], d))),(B[u][2] / (dist(B[u], d))),(B[u][3] / (dist(B[u], d))))
                            S    = np.sum(s,axis=0)
                            t[u] = 1 / dist(B[u],d)
                            T    = sum(t)
                        e   =[0]*4
                        ...
                        if tuple(e) in B:
                            ...
                            t=[0]*len(B)
                            for u in range(len(B)):
                                s[u] = (B[u][0] / (dist(B[u], e)),(B[u][1] / (dist(B[u], e))),(B[u][2] / (dist(B[u], e))),(B[u][3] / (dist(B[u], e))))
                                S    = np.sum(s,axis=0)
                                t[u] = 1 / dist(B[u],e)
                                T    = sum(t)
                            f   =[0]*4
                            ...
                            if tuple(f) in B:
                                ...
                                t=[0]*len(B)
                                for u in range(len(B)):
                                    s[u] = (B[u][0] / (dist(B[u], f)),(B[u][1] / (dist(B[u], f))),(B[u][2] / (dist(B[u], f))),(B[u][3] / (dist(B[u], f))))
                                    S    = np.sum(s,axis=0)
                                    t[u] = 1 / dist(B[u],f)
                                    T    = sum(t)
                                g   =[0]*4
                                ...
                                if tuple(g) in B: 
                                    ...
                                    t=[0]*len(B)
                                    for u in range(len(B)):
                                        s[u] = (B[u][0] / (dist(B[u], g)),(B[u][1] / (dist(B[u], g))),(B[u][2] / (dist(B[u], g))),(B[u][3] / (dist(B[u], g))))
                                        S    = np.sum(s,axis=0)
                                        t[u] = 1 / dist(B[u],g)
                                        T    = sum(t)
                                    h   =[0]*4
                                    ...
                                    if tuple(h) in B:
                                        ...
                                        t=[0]*len(B)
                                        for u in range(len(B)):
                                            s[u] = (B[u][0] / (dist(B[u], h)),(B[u][1] / (dist(B[u], h))),(B[u][2] / (dist(B[u], h))),(B[u][3] / (dist(B[u], h))))
                                            S    = np.sum(s,axis=0)
                                            t[u] = 1 / dist(B[u],h)
                                            T    = sum(t)
                                        j  =[0]*4
                                        ...
                                        if tuple(j) in B:
                                            ...
                                            t=[0]*len(B)
                                            for u in range(len(B)):
                                                s[u] = (B[u][0] / (dist(B[u], j)),(B[u][1] / (dist(B[u], j))),(B[u][2] / (dist(B[u], j))),(B[u][3] / (dist(B[u], j))))
                                                S    = np.sum(s,axis=0)
                                                t[u] = 1 / dist(B[u],j)
                                                T    = sum(t)
                                            k   =[0]*4
                                            ...
                                            if tuple(k) in B:
                                                ...
                                                t=[0]*len(B)
                                                for u in range(len(B)):
                                                    s[u] = (B[u][0] / (dist(B[u], k)),(B[u][1] / (dist(B[u], k))),(B[u][2] / (dist(B[u], k))),(B[u][3] / (dist(B[u], k))))
                                                    S    = np.sum(s,axis=0)
                                                    t[u] = 1 / dist(B[u],k)
                                                    T    = sum(t)
                                                l   =[0]*4
                                                ...
                                                if tuple(l) in B:
                                                    ...
                                                    t=[0]*len(B)
                                                    for u in range(len(B)):
                                                        s[u] = (B[u][0] / (dist(B[u], l)),(B[u][1] / (dist(B[u], l))),(B[u][2] / (dist(B[u], l))),(B[u][3] / (dist(B[u], l))))
                                                        S    = np.sum(s,axis=0)
                                                        t[u] = 1 / dist(B[u],l)
                                                        T    = sum(t)
                                                    m   =[0]*4
                                                    ...
                                                    if tuple(m) in B:
                                                        ...
                                                        t=[0]*len(B)
                                                        for u in range(len(B)):
                                                            s[u] = (B[u][0] / (dist(B[u], m)),(B[u][1] / (dist(B[u], m))),(B[u][2] / (dist(B[u], m))),(B[u][3] / (dist(B[u], m))))
                                                            S    = np.sum(s,axis=0)
                                                            t[u] = 1 / dist(B[u],m)
                                                            T    = sum(t)
                                                        n   =[0]*4
                                                        ...
                                                        if tuple(n) in B:
                                                            ...
                                                            t=[0]*len(B)
                                                            for u in range(len(B)):
                                                                s[u] = (B[u][0] / (dist(B[u], n)),(B[u][1] / (dist(B[u], n))),(B[u][2] / (dist(B[u], n))),(B[u][3] / (dist(B[u], n))))
                                                                S    = np.sum(s,axis=0)
                                                                t[u] = 1 / dist(B[u],n)
                                                                T    = sum(t)
                                                            o   =[0]*4
                                                            ...
                                                            if tuple(o) in B:
                                                                ...
                                                                t=[0]*len(B)
                                                                for u in range(len(B)):
                                                                    s[u] = (B[u][0] / (dist(B[u], o)),(B[u][1] / (dist(B[u], o))),(B[u][2] / (dist(B[u], o))),(B[u][3] / (dist(B[u], o))))
                                                                    S    = np.sum(s,axis=0)
                                                                    t[u] = 1 / dist(B[u],o)
                                                                    T    = sum(t)
                                                                p   =[0]*4
                                                                ...
                                                                if tuple(p) in B:
                                                                    ...
                                                                    t=[0]*len(B)
                                                                    for u in range(len(B)):
                                                                        s[u] = (B[u][0] / (dist(B[u], p)),(B[u][1] / (dist(B[u], p))),(B[u][2] / (dist(B[u], p))),(B[u][3] / (dist(B[u], p))))
                                                                        S    = np.sum(s,axis=0)
                                                                        t[u] = 1 / dist(B[u],p)
                                                                        T    = sum(t)
                                                                    q   =[0]*4
                                                                    ...
                                                                    if tuple(q) in B:
                                                                        ...
                                                                        t=[0]*len(B)
                                                                        for u in range(len(B)):
                                                                            s[u] = (B[u][0] / (dist(B[u], q)),(B[u][1] / (dist(B[u], q))),(B[u][2] / (dist(B[u], q))),(B[u][3] / (dist(B[u], q))))
                                                                            S    = np.sum(s,axis=0)
                                                                            t[u] = 1 / dist(B[u],q)
                                                                            T    = sum(t)
                                                                        r   =[0]*4
                                                                        ...
                                                                        if tuple(r) in B:
                                                                            ...
                                                                            t=[0]*len(B)
                                                                            for u in range(len(B)):
                                                                                s[u] = (B[u][0] / (dist(B[u], r)),(B[u][1] / (dist(B[u], r))),(B[u][2] / (dist(B[u], r))),(B[u][3] / (dist(B[u], r))))
                                                                                S    = np.sum(s,axis=0)
                                                                                t[u] = 1 / dist(B[u],r)
                                                                                T    = sum(t)
                                                                            x   =[0]*4
                                                                            ...
                                                                            if tuple(x) in B:
                                                                                ...
                                                                                for u in range(len(B)):
                                                                                    s[u] = (B[u][0] / (dist(B[u], x)),(B[u][1] / (dist(B[u], x))),(B[u][2] / (dist(B[u], x))),(B[u][3] / (dist(B[u], x))))
                                                                                    S    = np.sum(s,axis=0)
                                                                                    t[u] = 1 / dist(B[u],x)
                                                                                    T    = sum(t)
                                                                                y   =[0]*4
                                                                                ...
                                                                                if tuple(y) in B:
                                                                                    ...
                                                                                    t=[0]*len(B)
                                                                                    for u in range(len(B)):
                                                                                        s[u] = (B[u][0] / (dist(B[u], y)),(B[u][1] / (dist(B[u], y))),(B[u][2] / (dist(B[u], y))),(B[u][3] / (dist(B[u], y))))
                                                                                        S    = np.sum(s,axis=0)
                                                                                        t[u] = 1 / dist(B[u],y)
                                                                                        T    = sum(t)
                                                                                    finalminimizer=[0]*4
                                                                                    ...
                                                                                    finalminimizer[2]= S[3]/T
                                                                                    finalminimizer[3]= S[3]/T
                                                                                    z=finalminimizer
...
def d4grid(a,b):
    ...
    B = list(itertools.product(C,repeat=4)) #all possible points
    middlepoints = list(itertools.combinations_with_replacement(B,b-3)) #chooses b-3 points
    left = [None]*(a+1) #empty 
    top  = [None]*(a+1) #empty
    bottom = [None]*(a+1) #empty
    for n in range(a+1):
        left[n]  = (0,0,0,n) #choose a point on y axis
        bottom[n]= (n,0,0,0) #bottom of grid- x axis
        top[n]   = (n,n,n,a) #top of grid
